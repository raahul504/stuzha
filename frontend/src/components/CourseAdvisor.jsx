...
export default function CourseAdvisor({ onClose }) {
  ...
  return (
    <div className="bg-dcs-dark-gray rounded-2xl w-full h-[450px] sm:h-[500px] md:h-[600px] flex flex-col border border-dcs-purple/30 shadow-2xl relative overflow-hidden">
